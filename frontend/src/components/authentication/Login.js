...
const Login = () => {
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      toast({ title: "Error Occurred!", description: error.response?.data?.message || "Something went wrong", status: "error", duration: 5000, isClosable: true, position: "bottom" });
      setLoading(false);
    }
  };
  ...
  return (
    <VStack spacing="16px">
      ...
      <Text fontSize="12px" color="rgba(255,255,255,0.2)" textAlign="center">
